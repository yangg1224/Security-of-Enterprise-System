...
#table(EDA$treat)
data <- data.frame(
  category=c("treat(IOS)", "control(Andriod)"),
  count=c(163, 168)
)
...
```{r sexism, fig.cap = "sexism by education level",echo=FALSE, fig.width=7, fig.height=5}
...
```{r internet, fig.cap = "internet usages",echo=FALSE, fig.width=15, fig.height=6}
